System.register(["../utils", "../context/context", "./cellRendererFactory"], function(exports_1, context_1) {
    "use strict";
    ...
    var utils_1, context_2, cellRendererFactory_1;
    ...
    return {
        ...
        execute: function() {
            ...
            let CellRendererService = class CellRendererService {
                ...
                useCellRenderer(cellRendererKey, eTarget, params) {
                ...
                checkForDeprecatedItems(cellRenderer) {
                ...
                doesImplementICellRenderer(cellRenderer) {
                ...
                lookUpCellRenderer(cellRendererKey) {
            ...
            CellRendererService = __decorate([
                context_2.Bean('cellRendererService'), 
                __metadata('design:paramtypes', [])
            ], CellRendererService);
            exports_1("CellRendererService", CellRendererService);
        }
    }
});
