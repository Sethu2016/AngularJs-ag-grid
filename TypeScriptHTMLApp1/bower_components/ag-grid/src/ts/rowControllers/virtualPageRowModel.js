System.register(["../utils", "../gridOptionsWrapper", "../entities/rowNode", "../context/context", "../eventService", "../selectionController", "../events", "../sortController", "../filter/filterManager", "../constants"], function(exports_1, context_1) {
    "use strict";
    ...
    var utils_1, gridOptionsWrapper_1, rowNode_1, context_2, eventService_1, selectionController_1, events_1, sortController_1, filterManager_1, constants_1;
    var logging, VirtualPageRowModel;
    return {
        setters:[
            function (utils_1_1) {
                utils_1 = utils_1_1;
        ...
        execute: function() {
            ...
            */
            logging = false;
            let VirtualPageRowModel = class VirtualPageRowModel {
                constructor() {
                ...
                createNodesFromRows(pageNumber, rows) {
                    var nodes = [];
                    if (rows) {
                ...
                createNode(data, virtualRowIndex, realNode) {
                ...
                removeFromLoading(pageNumber) {
                    var index = this.pageLoadsInProgress.indexOf(pageNumber);
                    this.pageLoadsInProgress.splice(index, 1);
                }
                pageLoadFailed(pageNumber) {
                    this.removeFromLoading(pageNumber);
                    this.checkQueueForNextLoad();
                }
                pageLoaded(pageNumber, rows, lastRow) {
                    this.putPageIntoCacheAndPurge(pageNumber, rows);
                    this.checkMaxRowAndInformRowRenderer(pageNumber, lastRow);
                    this.removeFromLoading(pageNumber);
                    this.checkQueueForNextLoad();
                }
                putPageIntoCacheAndPurge(pageNumber, rows) {
                ...
                checkMaxRowAndInformRowRenderer(pageNumber, lastRow) {
                    if (!this.foundMaxRow) {
                ...
                isPageAlreadyLoading(pageNumber) {
                    var result = this.pageLoadsInProgress.indexOf(pageNumber) >= 0 || this.pageLoadsQueued.indexOf(pageNumber) >= 0;
                    return result;
                }
                doLoadOrQueue(pageNumber) {
                ...
                addToQueueAndPurgeQueue(pageNumber) {
                    if (logging) {
                ...
                findLeastRecentlyAccessedPage(pageIndexes) {
                ...
                requestIsDaemon(datasourceVersionCopy) {
                ...
                setRowData(rows, refresh, firstId) {
            ...
            exports_1("VirtualPageRowModel", VirtualPageRowModel);
        }
    }
});
