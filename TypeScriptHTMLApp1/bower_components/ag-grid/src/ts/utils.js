System.register([], function(exports_1, context_1) {
    ...
    return {
        ...
        execute: function() {
            ...
            class Utils {
                static iterateObject(object, callback) {
                ...
                static mapObject(object, callback) {
                    var result = [];
                    Utils.iterateObject(object, (key, value) => {
                ...
                static find(collection, predicate, value) {
                ...
                static iterateArray(array, callback) {
                ...
                static isNodeOrElement(o) {
                    return this.isNode(o) || this.isElement(o);
                }
                //adds all type of change listeners to an element, intended to be a text field
                static addChangeListener(element, listener) {
                ...
                static existsAndNotEmpty(value) {
                ...
                static removeElement(parent, cssSelector) {
                    this.removeFromParent(parent.querySelector(cssSelector));
                }
                static removeFromParent(node) {
                ...
                static addOrRemoveCssClass(element, className, addOrRemove) {
                    if (addOrRemove) {
                ...
                static callIfPresent(func) {
                    if (func) {
                        func();
                    }
                }
                static addCssClass(element, className) {
                ...
                static offsetHeight(element) {
                    return element && element.clientHeight ? element.clientHeight : 0;
                }
                static offsetWidth(element) {
                    return element && element.clientWidth ? element.clientWidth : 0;
                }
                static removeCssClass(element, className) {
                    if (element.className && element.className.length > 0) {
                        var cssClasses = element.className.split(' ');
                ...
                static defaultComparator(valueA, valueB) {
                ...
                static formatNumberTwoDecimalPlacesAndCommas(value) {
                 ...
                 */
                static createIcon(iconName, gridOptionsWrapper, column, svgFactoryFunc) {
                    var eResult = document.createElement('span');
                    eResult.appendChild(this.createIconNoSpan(iconName, gridOptionsWrapper, column, svgFactoryFunc));
                    return eResult;
                }
                static createIconNoSpan(iconName, gridOptionsWrapper, colDefWrapper, svgFactoryFunc) {
                ...
                static addStylesToElement(eElement, styles) {
                    if (!styles) {
                        return;
                    }
                ...
                static isKeyPressed(event, keyToCheck) {
                    var pressedKey = event.which || event.keyCode;
                    return pressedKey === keyToCheck;
                }
                static setVisible(element, visible, visibleStyle) {
                    if (visible) {
                ...
                static setCheckboxState(eCheckbox, state) {
                ...
                static traverseNodesWithKey(nodes, callback) {
                    var keyParts = [];
