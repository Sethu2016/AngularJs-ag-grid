System.register(["./columnUtils", "../entities/columnGroup", "../entities/originalColumnGroup", "../context/context"], function(exports_1, context_1) {
    "use strict";
    ...
    var columnUtils_1, columnGroup_1, originalColumnGroup_1, context_2, context_3;
    ...
    return {
        ...
        execute: function() {
            ...
            let DisplayedGroupCreator = class DisplayedGroupCreator {
                createDisplayedGroups(sortedVisibleColumns, balancedColumnTree, groupInstanceIdCreator) {
                    var result = [];
                ...
                createFakePath(balancedColumnTree) {
                    var result = [];
            ...
            exports_1("DisplayedGroupCreator", DisplayedGroupCreator);
        }
    }
});
