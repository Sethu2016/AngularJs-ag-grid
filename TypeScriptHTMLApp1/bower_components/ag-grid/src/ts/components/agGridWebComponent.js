System.register(["./componentUtil", "../grid"], function(exports_1, context_1) {
    "use strict";
    var __moduleName = context_1 && context_1.id;
    var componentUtil_1, grid_1;
    var registered;
    function initialiseAgGridWithWebComponents() {
        ...
        componentUtil_1.ComponentUtil.ALL_PROPERTIES.forEach((key) => {
    ...
    exports_1("initialiseAgGridWithWebComponents", initialiseAgGridWithWebComponents);
