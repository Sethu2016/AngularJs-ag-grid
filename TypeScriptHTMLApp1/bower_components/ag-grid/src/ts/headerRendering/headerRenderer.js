System.register(["../gridOptionsWrapper", "../columnController/columnController", "../gridPanel/gridPanel", "../entities/column", "../context/context", "./headerContainer", "../eventService", "../events"], function(exports_1, context_1) {
    "use strict";
    ...
    var gridOptionsWrapper_1, columnController_1, gridPanel_1, column_1, context_2, headerContainer_1, eventService_1, events_1;
    var HeaderRenderer;
    return {
        setters:[
        ...
        execute: function() {
            let HeaderRenderer = class HeaderRenderer {
                init() {
            ...
            HeaderRenderer = __decorate([
                context_2.Bean('headerRenderer'), 
                __metadata('design:paramtypes', [])
            ], HeaderRenderer);
            exports_1("HeaderRenderer", HeaderRenderer);
        }
    }
});
